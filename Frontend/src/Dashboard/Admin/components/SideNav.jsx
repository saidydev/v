                    ...
                    <nav className="h-full px-3 py-4">
                        <div className="flex flex-col gap-y-2">
                            ...
                            <Link
                                ...
                                className={`flex items-center gap-x-4 p-2.5 rounded-xs transition-colors ${ location.pathname === '/dashboard/admin/home'
                            ...
                            <Link
                                ...
                                onClick={() => setIsOpen(false)}
                                className={`flex items-center gap-x-4 p-2.5 rounded-xs transition-colors ${ location.pathname === '/dashboard/admin/profile'
                                    ? 'bg-blue-100 text-blue-600'
                                    : 'text-gray-600 hover:bg-gray-100'
                                    }`}
                            >
                            ...
                            <Link
                                ...
                                onClick={() => setIsOpen(false)}
                                className={`flex items-center gap-x-4 p-2.5 rounded-xs transition-colors ${ location.pathname === '/dashboard/admin/bookings'
                                    ? 'bg-blue-100 text-blue-600'
                                    : 'text-gray-600 hover:bg-gray-100'
                                    }`}
                            >
                            ...
                            <Link
                                ...
                                onClick={() => setIsOpen(false)}
                                className={`flex items-center gap-x-4 p-2.5 rounded-xs transition-colors ${ location.pathname === '/dashboard/admin/users'
                                    ? 'bg-blue-100 text-blue-600'
                                    : 'text-gray-600 hover:bg-gray-100'
                                    }`}
                            >
